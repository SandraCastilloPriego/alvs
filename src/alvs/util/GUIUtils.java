...
import alvs.util.Tables.DataTable;
import alvs.util.Tables.DataTableModel;
import alvs.util.Tables.impl.PushableTable;
import alvs.util.components.FileUtils;
import alvs.util.internalframe.DataInternalFrame;
...
public class GUIUtils {
        ...
        /**
         * Calls the function generateHelpID(Class<?> cl) to generate the path of the help file
         * depending on the name of the class which calls it.
         *
        ...
        /**
         * Creates the table of the data set and puts it into an internal frame to show it in desktop.
         *
         * @param dataset data set which will be shown
         */
        public static void showNewTable(BugDataset dataset, boolean addDataset) {
                ...
                if (addDataset) {
                        ALVSCore.getDesktop().AddNewFile(dataset);
                }
