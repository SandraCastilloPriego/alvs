...
public class ALVSHelpMap implements Map {
        ...
        public void setTarget(String target) {
                String url;
                if (test) {
                        url = "jar:file:" + System.getProperty("user.dir") + "/dist/ALVS.jar!/" + target;
                } else {
                        url = "jar:file:" + System.getProperty("user.dir") + "/ALVS.jar!/" + target;
                }
